...
app.post('/api/payment-link', async (req, res) => {
  ...
  const body = {
    ...
    provider: provider && provider !== 'CARD' ? provider : undefined,
...
app.post('/api/payment-notify', (req, res) => {
  // The browser-side order history is localStorage, so this endpoint acknowledges
  // Papi's notification; the frontend confirms the final state via /api/payment-status.
